      ...
      <aside className="hidden lg:flex flex-col w-64 min-h-screen px-4 py-8 overflow-y-auto bg-base-200 border-r rtl:border-r-0 rtl:border-l dark:bg-gray-900 dark:border-gray-700">
        ...
        <div className="flex flex-col items-center mt-6 -mx-2">
          <img
            ...
            alt="avatar"
          />
          <h4 className="mx-2 mt-2 font-medium  dark:text-gray-200">
            {user?.displayName}
          </h4>
        ...
        <div className="flex flex-col justify-between flex-1 mt-6">
          <nav>
            ...
            >
              ...
              <span className="mx-4 font-medium">Add New Services</span>
            </NavLink>
            <NavLink
              className="flex items-center px-4 py-2 mt-5 text-gray-600 transition-colors duration-300 transform rounded-lg dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-800 dark:hover:text-gray-200 hover:text-gray-700"
            ...
            >
              ...
              <span className="mx-4 font-medium">My Services</span>
            </NavLink>

            <li
              className="flex items-center px-4 py-2 mt-5 text-gray-600
             transition-colors duration-300 transform rounded-lg dark:text-gray-400  dark:hover:bg-gray-800 dark:hover:text-gray-200 hover:text-gray-700"
            >
              <BiBookmarks />
              <details tabIndex={0}>
                ...
                <ul className="p-2">
                  <li>
                    <NavLink
                      className={({ isActive }) =>
                        isActive
                          ? "text-secondary-focus ml-2 mb-2 font-bold border-b-2"
                          : "text-white ml-2 mb-2"
                      }
                      to="/dashboard/mySchedules/myBooking"
                    >
                      My Booking
                    </NavLink>
                  </li>
                  <li>
                    <NavLink
                      ...
                      to="/dashboard/mySchedules/myPending"
                    >
                      My Pending works
                    </NavLink>
                  </li>
